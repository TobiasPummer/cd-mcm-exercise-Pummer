...
func TestUpdateProduct(t *testing.T) {
	...
	updateBody := `{"name":"Widget Pro","price":19.99}`
	...
	if !strings.Contains(rr.Body.String(), "Widget Pro") {
		t.Errorf("expected updated name in response, got %s", rr.Body.String())
	}
}
